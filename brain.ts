...
export type QuickActionType = 'new_patient' | 'new_record' | 'new_occurrence' | 'new_agenda' | 'new_document' | null;
...
export interface Patient {
  ...
  paymentType?: string;
  monthly_fee?: number; // Adicionado para evitar erro
  reason?: string;
  prescriptions?: string[];
  metrics?: { label: string; value: string; trend: string }[];
}

// Nova interface para Transação Financeira
...
export interface BrainState {
  ...
  medications: any[];
  // Correção: Adicionado transactions na raiz E dentro de finances para compatibilidade

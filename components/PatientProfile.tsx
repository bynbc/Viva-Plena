...
import { 
  ...
  Trash2, CheckCircle2, CheckCircle
} from 'lucide-react';
    ...
    <div className="space-y-6 lg:space-y-10 animate-in slide-in-from-right-4 duration-500 relative pb-20">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 lg:gap-8 relative z-10">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          <button className="flex-1 sm:flex-none p-3 lg:p-4 glass-header border-white/50 rounded-[16px] lg:rounded-[22px] hover:bg-white/80 transition-all shadow-lg flex items-center justify-center text-slate-500 hover:text-emerald-600"><Printer size={18} lg:size={22}/></button>
          <button className="flex-1 sm:flex-none p-3 lg:p-4 glass-header border-white/50 rounded-[16px] lg:rounded-[22px] hover:bg-white/80 transition-all shadow-lg flex items-center justify-center text-slate-500 hover:text-emerald-600"><Edit2 size={18} lg:size={22}/></button>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 lg:gap-6">
                      <DateCard label="Ingresso" date={patient.admissionDate ? new Date(patient.admissionDate).toLocaleDateString('pt-BR') : '--'} />
              ...
              <div className="animate-in fade-in duration-500 space-y-8 lg:space-y-12">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-8">
                   <div className="bg-emerald-600/90 p-6 lg:p-10 rounded-[24px] lg:rounded-[48px] text-white shadow-xl border border-white/10 backdrop-blur-xl">
                      ...
                      <h4 className="text-2xl lg:text-4xl font-black tracking-tighter">
                   ...
                   <div className="glass p-6 lg:p-10 rounded-[24px] lg:rounded-[48px] border border-white/50 shadow-md flex flex-col justify-center text-center">
                      ...
                      <h4 className="text-sm lg:text-xl font-black text-slate-900 tracking-tighter">R$ --</h4>
                   </div>
                </div>

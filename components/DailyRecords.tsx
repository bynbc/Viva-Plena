...
import { FileText, Plus, Search, Clock, User, Tag } from 'lucide-react';
    ...
    <div className="space-y-6 lg:space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-4 lg:gap-6">
          {filtered.map((record) => (
            <div key={record.id} className="glass-card bg-white/40 p-6 lg:p-8 rounded-[32px] border border-white/60 shadow-sm hover:shadow-md transition-all">

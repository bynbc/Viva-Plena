...
const Users: React.FC = () => {
  ...
  const startEdit = (user: any) => {
    ...
    setEditEmail(user.email || ''); // Carrega o e-mail existente
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      await update('users', editingUser.id, payload);
          ...
          <div key={user.id} className="bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-xl font-black uppercase shadow-sm ${
                ...
                <div>
                  ...
                  <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded-md inline-block mt-1 ${
